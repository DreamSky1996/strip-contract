...
describe("StripBondingCalculator Test", function() {
  ...
  describe("StripBondingCalculator", function() {
    it("Strip", async () => {
      console.log("\tcheck strip address of StripBondingCalculator");
      expect(await bondingCalculator.Strip()).to.equal(strip.address);
    });
