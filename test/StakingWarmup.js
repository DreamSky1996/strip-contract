...
describe("StakingWarmup Test", function() {
  ...
  describe("StakingWarmup", function() {
    it("sStrip", async () => {
      console.log("\tcheck sStrip address of StakingWarmup");
      expect(await stakingWarmup.SStrip()).to.equal(sStrip.address);
    });
    it("staking", async () => {
      console.log("\tcheck staking address of StakingWarmup");
      expect(await stakingWarmup.staking()).to.equal(staking.address);
    });
  });
