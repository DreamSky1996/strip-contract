...
describe("StakingHelper Test", function() {
  ...
  describe("StakingHelper", function() {
    ...
    it("Strip", async () => {
      console.log("\tcheck strip address of StakingHelper");
      expect(await stakingHelper.Strip()).to.equal(strip.address);
    });
    it("staking", async () => {
      console.log("\tcheck staking address of StakingHelper");
      expect(await stakingHelper.staking()).to.equal(staking.address);
    });

    it("stake", async () => {
      console.log("\tcheck stake function");
